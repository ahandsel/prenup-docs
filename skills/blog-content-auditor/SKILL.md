...
* [docs/glossary.yaml][glossary] - approved terminology.
...
2. **Read the relevant style guides.** Load the general and technical guides for the file's language, plus the Markdown style guide and glossary. Skim `technical-doc-overview.md` to identify the intended document type.
...
* **Terminology.** Terms match [glossary.yaml][glossary]; suggest the approved alternative when a term diverges.
